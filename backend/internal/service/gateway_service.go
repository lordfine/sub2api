...
// stickySessionTTL 粘性会话TTL，可通过环境变量 STICKY_SESSION_TTL_MINUTES 覆盖（分钟，默认 60）。
var stickySessionTTL = loadStickySessionTTL()

func loadStickySessionTTL() time.Duration {
	if v := os.Getenv("STICKY_SESSION_TTL_MINUTES"); v != "" {
